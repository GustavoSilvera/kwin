    ...
    : public Effect
{
    ...
    Q_PROPERTY(bool forcePrimaryScreen READ configuredForcePrimaryScreen)
...
public:
    ...
    bool configuredForcePrimaryScreen() const {
        return m_forcePrimaryScreen;
    }
private:
